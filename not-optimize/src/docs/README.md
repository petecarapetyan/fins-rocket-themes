# not-optimize Rocket Theme

This is a theme for a [Rocket](https://rocket.modern-web.dev/) web site, loosely styled after the [google optimize site](https://optimize.withgoogle.com/)
...
As in, check out this project and copypaste these three folders from `not-optimize/src/docs/`
...
- [as personalized/customized](https://github.com/petecarapetyan/couldbe)
- [as deployed](https://couldbe.net/)
