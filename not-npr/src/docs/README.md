# not-npr Rocket Theme

This is a theme for a [Rocket](https://rocket.modern-web.dev/) web site, loosely styled after the [npr.org site](https://www.npr.org/)
...
As in, check out this project and copypaste these three folders from `not-npr/src/docs/`
...
- [as personalized/customized](https://github.com/petecarapetyan/appwriter)
- [as deployed](https://appwriter.com/)
