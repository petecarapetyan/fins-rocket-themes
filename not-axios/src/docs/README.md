# not-axios Rocket Theme

This is a theme for a [Rocket](https://rocket.modern-web.dev/) web site, loosely styled after the [axios site](https://www.axios.com/)
...
As in, check out this project and copypaste these three folders from `not-axios/src/docs/`
...
- [as personalized/customized](https://github.com/petecarapetyan/datafundamentals)
- [as deployed](https://datafundamentals.com)
